...
public class CartFragment extends Fragment implements View.OnClickListener {
    ...
    private void setControl(View view) {
        ...
        unitMoneyCartTotal = view.findViewById(R.id.unitMoneyCartTotal); //don vi cart
        unitMoneyCartTotal.setPaintFlags(unitMoneyCartTotal.getPaintFlags()| Paint.UNDERLINE_TEXT_FLAG); //gach chan
